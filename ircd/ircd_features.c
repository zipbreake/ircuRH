 ...
 *
 * $Id: ircd_features.c,v 1.2 2006/12/26 10:35:15 zipbreake Exp $
 */
#include "config.h"
...
#define F_S(type, flags, v_str, notify)					      \
  ...
  F_S(HIS_SERVERNAME, 0, "*.redhispana.org", 0),
  F_S(HIS_SERVERINFO, 0, "De hispanos para hispanos", 0),
  F_S(RH_PSEUDO_SERVERNAME, 0, "irc.redhispana.org", 0),
  F_S(HIS_URLSERVERS, 0, "http://www.redhispana.org/servers.php", 0),

  /* Misc. random stuff */
  F_S(NETWORK, 0, "RedHispana", 0),
  ...
  F_I(AUTH_TIMEOUT, 0, 5, 0),
  F_B(HIDDEN_SERVER, 0, 1, 0),
