 ...
 *
 *
 * $Id: client.h,v 1.2 2007/01/09 14:04:03 zipbreake Exp $
 */
...
#define RHFLAGS_DEVEL	0x04
#define RHFLAGS_COADM	0x08
#define RHFLAGS_ADM		0x10
#define RHFLAGS_PREOP	0x20
...
#define RHFLAGS_IDENTIFIED	0x200000

#define RHFLAGS_IPERSONALIZADA  0x400000

#define RHFLAGS (RHFLAGS_VIEWIP|RHFLAGS_HELPOP|RHFLAGS_DEVEL|RHFLAGS_COADM|RHFLAGS_ADM|RHFLAGS_PREOP|RHFLAGS_ONLYREG|RHFLAGS_REGNICK|RHFLAGS_USERBOT|RHFLAGS_BOT|RHFLAGS_SUSPENDED|RHFLAGS_IDENTIFIED)
...
#define es_representante(x) (cli_rhflags(x) & (RHFLAGS_HELPOP | RHFLAGS_COADM | RHFLAGS_ADM))
...
#define IsDevel(x)			(cli_rhflags(x) & RHFLAGS_DEVEL)
#define IsCoadmin(x)			(cli_rhflags(x)	& RHFLAGS_COADM)
#define IsAdmin(x)			(cli_rhflags(x) & RHFLAGS_ADM)
#define IsPreoper(x)			(cli_rhflags(x) & RHFLAGS_PREOP)
...
#define IsIdentified(x)			(cli_rhflags(x) & RHFLAGS_IDENTIFIED)
...
#define SetDevel(x)			(cli_rhflags(x) |= RHFLAGS_DEVEL)
#define SetCoadmin(x)			(cli_rhflags(x) |= RHFLAGS_COADM)
#define SetAdmin(x)			(cli_rhflags(x) |= RHFLAGS_ADM)
#define SetPreoper(x)			(cli_rhflags(x) |= RHFLAGS_PREOP)
...
#define SetIdentified(x)		(cli_rhflags(x) |= RHFLAGS_IDENTIFIED)
...
#define ClearDevel(x)			(cli_rhflags(x) &= ~RHFLAGS_DEVEL)
#define ClearCoadmin(x)			(cli_rhflags(x) &= ~RHFLAGS_COADM)
#define ClearAdmin(x)			(cli_rhflags(x) &= ~RHFLAGS_ADM)
#define ClearPreoper(x)			(cli_rhflags(x) &= ~RHFLAGS_PREOP)
...
#define ClearIdentified(x)		(cli_rhflags(x) &= ~RHFLAGS_IDENTIFIED)
